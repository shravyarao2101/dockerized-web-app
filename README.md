...
This project demonstrates containerization of a simple web application using Docker.
...
\- Prepare for CI/CD and Kubernetes workflows
...
* Analyzed Docker image layers using docker history
